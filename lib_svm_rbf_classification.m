function [classification, test_decision_values] = lib_svm_rbf_classification(train_data, train_labels, test_data, test_labels, C, G)
...
%     addpath('/home/lab/lior/Projects/general use functions/libsvm-dense-3.18/matlab/');
    ...
    svmOptions = sprintf('-c %g -g %g', C ,G);
